...
const UserProfileView: React.FC<UserProfileViewProps> = ({ 
    ...
    const isBot = user.email === 'nathancodnext@gmail.com' || user.username === 'SOPORTE';
                    ...
                    {isEditingUsername ? (
                        ...
                        <>
                            <div className="flex items-center gap-3">
                                ...
                                {isBot && (
                                    <span className="text-[10px] font-black bg-misionero-verde text-white px-3 py-1 rounded-full">BOT</span>
                                )}
